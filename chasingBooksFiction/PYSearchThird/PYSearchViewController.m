...
#define MainColor    PYSEARCH_COLOR(205, 92, 92)//搜索框的颜色
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    if (NO == self.navigationController.navigationBar.translucent) {
        ...
        self.searchSuggestionVC.view.frame = CGRectMake(0, TopAndSystemHeight - self.view.py_y, self.view.py_width, self.view.py_height + self.view.py_y);
...
//            }
//        };
//        searchSuggestionVC.view.frame = CGRectMake(0, TopAndSystemHeight, PYScreenW, PYScreenH);
...
//    self.baseSearchTableView.separatorStyle = UITableViewCellSeparatorStyleSingleLineEtched;
...
//    self.navigationItem.rightBarButtonItem.tintColor = MyColor(0, 165, 65);
    ...
    titleView.py_y = 7;
    titleView.py_width = self.view.py_width - TopAndSystemHeight - titleView.py_x * 2;
    ...
    switch (self.searchResultShowMode) {
        ...
        case PYSearchResultShowModeEmbed:
            if (self.searchResultController) {
                ...
                self.searchResultController.view.hidden = NO;
                self.searchResultController.view.py_y = NO == self.navigationController.navigationBar.translucent ? 0 : TopAndSystemHeight;
